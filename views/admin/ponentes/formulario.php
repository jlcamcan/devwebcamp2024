<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="imagen" class="formulario__label">Fotografía</label>
        <input 
            type="file"
    ...
    <?php if(isset($ponente->imagen_actual)){ ?> 
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <img src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen;?>.png" alt="Imagen Ponentes">
            </picture>
