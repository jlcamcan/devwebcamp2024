<footer class="footer">
    <div class="footer__grid">
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noreferrer noopener " target="_blank" href="https://twitter.com">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/jlcamcan">
                <span class="menu-redes__ocultar">GitHub</span>
            </a>
        </nav><!-- fin nav menu-redes  -->
    </div><!-- fin footer__grid  -->
