...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        ...
        <p class="eventos-registro__fecha">Viernes 1 de Noviembre</p>
        <div class="eventos-registro__grid">
            <?php foreach($eventos['conferencias_v'] as $evento ){?> 
                  <?php include __DIR__ . '/evento.php'; ?> 
            <?php }?> 
        </div>
        <p class="eventos-registro__fecha">Sábado 2 de Noviembre</p>
        <div class="eventos-registro__grid">
            <?php foreach($eventos['conferencias_s'] as $evento ){?> 
                  <?php include __DIR__ . '/evento.php'; ?> 
            <?php }?> 
        </div><!--. fin conferencias-->
    ...
    <aside class="registro">
        ...
        <div class="registro__regalo">
            <label for="regalo" class="registro__label">Añade un regalo</label>
        ...
        <form id="registro" class="formulario">
            <div class="formulario__campo">
                <input type="submit" class="formulario__submit formulario__submit--full"
                value="Registrarme">
            </div>
        </form>
    </aside>
